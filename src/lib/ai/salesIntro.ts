...
## 語尾・言い回しのルール（重要）
- 「〜してくれるでしょう」「〜が魅力です」など断定的な褒め言葉は使わない
- 口コミや評価データを根拠とした言い回しにする
- 例：「と多くの施主が感じています」「と評価されることが多いようです」「という声が見られます」「という印象を持つ方が多いようです」
- 口コミがない場合はプロフィール情報からの推測であることが伝わる語尾にする
- 例：「という傾向がうかがえます」「と考えられます」
